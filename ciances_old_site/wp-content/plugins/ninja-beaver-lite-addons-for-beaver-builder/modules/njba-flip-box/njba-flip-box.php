...
/**
 *
 * @class NJBAFlipBoxModule
 */
class NJBAFlipBoxModule extends FLBuilderModule {
    /**
     * @method __construct
     */
 ...
 */
FLBuilder::register_module('NJBAFlipBoxModule', array(
            ...
            'general'       => array( // Section
                ...
                'fields'        => array( // Section Fields
                    'box_minimum_height'    => array( 
                        'type'        => 'text',
                        'label'       => __('Box Minimum Height', 'bb-njba'),
                        'default'     => '',
                        'maxlength'   => '3',
                        'size'        => '3',
                        'preview'           => array(
                            'type'              => 'css',
                            //'selector'          => '.njba-face.njba-front',
                            'selector'          => array( '.njba-face.njba-front', '.njba-face.njba-back'),
                            'property'          => 'min-height',
                            'unit'              => 'px'
                        ),
                    ),
