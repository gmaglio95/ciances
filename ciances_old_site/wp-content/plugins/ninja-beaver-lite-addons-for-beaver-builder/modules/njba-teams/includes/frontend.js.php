<?php if($settings->teams_layout_view === "slider")
	 { 
?>
(function($) {
<?php if($settings->teams_layout_view == 'slider'):
			if ( count($settings->teams ) > 1 ) : ?>
	
			
		    var window_width = $(window).width();
		    var section_width =$(".fl-node-<?php echo $id; ?> .njba-teams-main").width();
			// Create the slider.
			var sliderOptions = {
				auto : true,
				...
				onSliderLoad: function() {
					$('.fl-node-<?php echo $id; ?> .njba-teams-main').addClass('njba-teams-loaded');
				}
			};
		    ...
		    if(window_width > 990) {
	   		...
	   		$('.fl-node-<?php echo $id; ?> .njba-teams-wrapper').bxSlider($.extend({}, sliderOptions, carouselOptions));
<?php 	endif; 
	endif;	?>
