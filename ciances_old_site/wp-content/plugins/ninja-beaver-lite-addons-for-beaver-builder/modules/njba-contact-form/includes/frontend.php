...
?>
<form class="njba-module-content njba-contact-form <?php echo 'njba-form-'.$settings->form_style; ?>" <?php if ( isset( $module->template_id ) ) echo 'data-template-id="' . $module->template_id . '" data-template-node-id="' . $module->template_node_id . '"'; ?>>
		...
		<div class="njba-input-group njba-first-name <?php echo $first_name_class; ?>">
			...
			<div class="njba-form-outter">
				<div class="njba-form-validation">
					<input type="text" name="njba-first-name" value="" <?php if($settings->enable_placeholder == 'yes' ) { ?> placeholder="<?php echo $settings->first_name_placeholder; ?>" <?php } ?>/>
	...
	<?php endif; ?>
		...
		<div class="njba-input-group njba-last-name <?php echo $last_name_class; ?>">
			...
			<div class="njba-form-outter">
				<div class="njba-form-validation">
					<input type="text" name="njba-last-name" value="" <?php if($settings->enable_placeholder == 'yes' ) { ?> placeholder="<?php echo $settings->last_name_placeholder; ?>" <?php } ?>/>
					<div class="njba-form-error-message njba-form-error-message-required"></div>
					<?php if($settings->enable_icon == 'yes' ) { ?>
					 	<?php echo $lname; ?>
					 <?php } ?>
	...
	<?php endif; ?>
		...
		<div class="njba-input-group njba-email <?php echo $email_class; ?>">
			...
			<div class="njba-form-outter">
				<div class="njba-form-validation">
					<input type="email" name="njba-email" value="" <?php if($settings->enable_placeholder == 'yes' ) { ?>placeholder="<?php echo $settings->email_placeholder; ?>"<?php } ?>/>
					<div class="njba-form-error-message njba-form-error-message-required"></div>
					<?php if($settings->enable_icon == 'yes' ) { ?>
					 	<?php echo $email; ?>
					 <?php } ?>
				</div>	
				<span class="njba-contact-error">Please enter a email.</span>
				<span class="njba-error-email-msg">Please enter a Valid email.</span>
	...
	<?php endif; ?>
		...
		<div class="njba-input-group njba-subject <?php echo $subject_class; ?>">
			...
			<div class="njba-form-outter">
				<div class="njba-form-validation">
					<input type="text" name="njba-subject" value="" <?php if($settings->enable_placeholder == 'yes' ) { ?>placeholder="<?php echo $settings->subject_placeholder; ?>"<?php } ?>/>
					<div class="njba-form-error-message njba-form-error-message-required"></div>
					<?php if($settings->enable_icon == 'yes' ) { ?>
					 	<?php echo $subject; ?>
					 <?php } ?>
		...
		<div class="njba-input-group njba-phone <?php echo $phone_class; ?>">
			...
			<div class="njba-form-outter">
				<div class="njba-form-validation">
					<input type="tel" name="njba-phone" value="" <?php if($settings->enable_placeholder == 'yes' ) { ?>placeholder="<?php echo $settings->phone_placeholder; ?>"<?php } ?> />
					<div class="njba-form-error-message njba-form-error-message-required"></div>
					<?php if($settings->enable_icon == 'yes' ) { ?>
					 	<?php echo $phone; ?>
					 <?php } ?>
	...
	<div class="njba-input-group njba-message <?php echo $msg_class; ?>">
		...
		<div class="njba-form-outter-textarea">
			<div class="njba-form-validation">
				<textarea name="njba-message" <?php if($settings->enable_placeholder == 'yes' ) { ?>placeholder="<?php echo $settings->msg_placeholder; ?>"<?php } ?>></textarea>
				<div class="njba-form-error-message njba-form-error-message-required"></div>
				<?php if($settings->enable_icon == 'yes' ) { ?>
					 	<?php echo $msg; ?>
					 <?php } ?>
	...
	<?php elseif($settings->success_action == 'none') : ?>  
		<span class="njba-success-none" style="display:none;"><?php echo $settings->email_sccess; ?></span>
	<?php endif; ?> 
