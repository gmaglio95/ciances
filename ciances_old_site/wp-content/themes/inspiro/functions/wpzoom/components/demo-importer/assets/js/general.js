...
function wpzoom_load_demo_content_done() {
    ...
    if ( demoImporter.zoomData.demo_imported != '' ) {
        $.cookie(demoImporter.zoomData.theme_raw_name + '_' + demoImporter.zoomData.demo_imported + "_demo_content_done", 1, { expires : 365 });
    } else {
        $.cookie(demoImporter.zoomData.theme_raw_name + '_' + demoImporter.zoomData.theme_raw_name + "_demo_content_done", 1, { expires : 365 });
    }
...
function wpzoom_delete_demo_content_done() {
    ...
    // Delete cookies
    $.removeCookie(demoImporter.zoomData.theme_raw_name + '_' + demoImporter.zoomData.demo_imported + "_demo_content_done");
    $.removeCookie(demoImporter.zoomData.theme_raw_name + '_' + demoImporter.zoomData.theme_raw_name + "_demo_content_done");
    $.removeCookie(demoImporter.zoomData.theme_raw_name + '_' + demoImporter.zoomData.demo_imported + "_steps_status");
    $.removeCookie(demoImporter.zoomData.theme_raw_name + '_' + demoImporter.zoomData.demo_imported + "_theme_setup_is_complete");
