<?php
/**
 * @class NJBAPostGridModule
 */
class NJBAPostGridModule extends FLBuilderModule {
    /**
 ...
 */
FLBuilder::register_module('NJBAPostGridModule', array(
		'general'      => array( // Tab
