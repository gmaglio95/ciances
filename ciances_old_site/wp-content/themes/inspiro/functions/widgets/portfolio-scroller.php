...
class Wpzoom_Portfolio_Scroller extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        $scroll_infinitely = $instance['scroll_infinitely'] === false;
            ...
            jQuery(function($) {
                ...
                $c.imagesLoaded( function(){
                    ...
                    $c.flickity({
                        ...
                        pageDots: false,
                        wrapAround: <?php echo $scroll_infinitely === false ? 'true' : 'false'; ?>,
                        freeScroll: true,
                        imagesLoaded: true,
                        accessibility: false,
                        arrowShape: {
    ...
    function update( $new_instance, $old_instance ) {
        ...
        $instance['hide_button'] = (bool) $new_instance['hide_button'];
        $instance['scroll_infinitely'] = (bool) $new_instance['scroll_infinitely'];
    ...
    function form( $instance ) {
        ...
        $defaults = array( 'title' => '', 'category' => 0, 'items_num' => 5, 'hide_title' => false, 'hide_excerpt' => false, 'hide_button' => false, 'auto_scroll' => true, 'scroll_infinitely' => false, );
