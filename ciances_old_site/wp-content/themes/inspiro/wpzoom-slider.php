        ...
        <ul class="slides">
            ...
            <?php while ($sliderLoop->have_posts()) : $sliderLoop->the_post(); ?>
                ...
                $vimeo_player_args = array(
                   ...
                   'data-vimeo-muted'    => $sound,
                   'data-vimeo-loop'     => $loop,
                   'data-vimeo-byline'   => 0,
                   'data-vimeo-title'    => 0,
                   'data-vimeo-id'       => $vimeo_video_id,
                ...
                <li <?php echo $style; ?>
                    <?php if ( $is_formstone && ( $is_video_slide || $is_video_external ) ): ?>data-background-options='<?php echo json_encode( $encode_array ); ?>'
                       <?php endif; ?>
                   <?php if ( $is_vimeo_pro ): ?>
                       <?php echo array_to_data_atts( $vimeo_player_args ); ?>
                   <?php endif; ?>>
