...
.fl-node-<?php echo $id; ?> .njba-image .njba-sep-image {
     ...
     <?php if($settings->image_style == 'custom') : ?>
        ...
        <?php if( $settings->image_bg_color ) { ?>background-color: rgba(<?php echo implode(',', FLBuilderColor::hex_to_rgb($settings->image_bg_color )) ?>, <?php echo $settings->img_bg_color_opc/100; ?>); <?php } ?>
    ...
    -webkit-box-shadow: <?php echo $settings->box_shadow['horizontal']; ?>px <?php echo $settings->box_shadow['vertical']; ?>px <?php echo $settings->box_shadow['blur']; ?>px <?php echo $settings->box_shadow['spread']; ?>px #<?php echo $settings->box_shadow_color; ?>; <?php echo $settings->box_shadow_opacity / 100; ?>;
     
    -moz-box-shadow: <?php echo $settings->box_shadow['horizontal']; ?>px <?php echo $settings->box_shadow['vertical']; ?>px <?php echo $settings->box_shadow['blur']; ?>px <?php echo $settings->box_shadow['spread']; ?>px #<?php echo $settings->box_shadow_color; ?>; <?php echo $settings->box_shadow_opacity / 100; ?>;
    -o-box-shadow: <?php echo $settings->box_shadow['horizontal']; ?>px <?php echo $settings->box_shadow['vertical']; ?>px <?php echo $settings->box_shadow['blur']; ?>px <?php echo $settings->box_shadow['spread']; ?>px #<?php echo $settings->box_shadow_color; ?>; <?php echo $settings->box_shadow_opacity / 100; ?>;
    box-shadow: <?php echo $settings->box_shadow['horizontal']; ?>px <?php echo $settings->box_shadow['vertical']; ?>px <?php echo $settings->box_shadow['blur']; ?>px <?php echo $settings->box_shadow['spread']; ?>px #<?php echo $settings->box_shadow_color; ?>; <?php echo $settings->box_shadow_opacity / 100; ?>; 
    <?php endif; ?>
}
.fl-node-<?php echo $id; ?> .njba-image .njba-sep-image {
    <?php if( !empty( $settings->img_size ) ) : ?>
...
.fl-node-<?php echo $id; ?> .njba-image .njba-sep-image:hover {
    <?php if($settings->image_style == 'custom') : ?>
        <?php if( $settings->img_bg_hover_color ) { ?>background-color: rgba(<?php echo implode(',', FLBuilderColor::hex_to_rgb($settings->img_bg_hover_color )) ?>, <?php echo $settings->img_bg_hover_color_opc/100; ?>); <?php } ?>
