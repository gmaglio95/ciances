...
/**
 * @class NJBATwitterTimelineModule
 */
class NJBATwitterTimelineModule extends FLBuilderModule {
 ...
 */
FLBuilder::register_module('NJBATwitterTimelineModule', array(
	'general'       => array( // Tab
			...
			'general'       => array( // Section
				...
				'fields'        => array( // Section Fields
					...
					'layout'  => array(
						...
						'multi-select'  => true,
						'description'	=> __('Press <strong>ctrl + click</strong> OR <strong>cmd + click</strong> OR <strong>shift + click</strong> to select multiple.', 'bb-njba')
					),
					'width'     	=> array(
						'type'          => 'text',
