...
.fl-node-<?php echo $id; ?> .njba-input-group .njba-input-icon i{
	...
	color: #<?php echo $settings->input_icon_color; ?>;
	
	<?php echo ( $settings->input_icon_size != '' ) ? 'font-size: ' . $settings->input_icon_size . 'px;' : ''; ?>
}
.fl-node-<?php echo $id; ?> .njba-input-group .njba-input-icon{
	
	<?php echo ( $settings->position_top != '' ) ? 'top: ' . $settings->position_top . 'px;' : ''; ?> 
	<?php echo ( $settings->position_left != '' ) ? 'left: ' . $settings->position_left . 'px;' : ''; ?> 		
}
...
.fl-node-<?php echo $id; ?> .njba-contact-form input[type="email"] {
	 <?php if( $settings->input_padding['top'] != '' ) { ?> padding-top: <?php echo $settings->input_padding['top']; ?>px;<?php } ?>
	<?php if( $settings->input_padding['bottom'] != '' ) { ?>padding-bottom: <?php echo $settings->input_padding['bottom']; ?>px; <?php } ?>
	<?php if( $settings->input_padding['left'] != '' ) { ?>padding-left: <?php echo $settings->input_padding['left']; ?>px; <?php } ?>
	<?php if( $settings->input_padding['right'] != '' ) { ?>padding-right: <?php echo $settings->input_padding['right']; ?>px; <?php } ?>
}
...
.fl-node-<?php echo $id; ?> .njba-contact-form .njba-input-group-wrap textarea{
	<?php if( $settings->input_background_color ) { ?>background-color: rgba(<?php echo implode(',', FLBuilderColor::hex_to_rgb($settings->input_background_color )) ?>, <?php echo $settings->input_background_color_opc/100; ?>); <?php } ?>
	text-align: <?php echo $settings->input_text_align; ?>;
	<?php if( $settings->input_border_color ) { ?>border-color: #<?php echo $settings->input_border_color; ?>;<?php } ?>
	<?php if( $settings->input_border_radius ) { ?>border-radius: <?php echo $settings->input_border_radius; ?>px;<?php } ?>
	<?php if( $settings->input_border_width ) { ?>border-width: <?php echo $settings->input_border_width; ?>px;<?php } ?> 
}
...
.fl-node-<?php echo $id; ?> .njba-contact-form.njba-form-style2 .njba-input-group-wrap textarea{
	<?php if( $settings->input_border['top'] != '' ) { ?> border-top: <?php echo $settings->input_border['top']; ?>px <?php echo $settings->border_style; ?> #<?php echo $settings->border_color; ?>;  <?php } ?>
		<?php if( $settings->input_border['bottom'] != '' ) { ?>border-bottom: <?php echo $settings->input_border['bottom']; ?>px <?php echo $settings->border_style; ?> #<?php echo $settings->border_color; ?>; <?php } ?>
		<?php if( $settings->input_border['left'] != '' ) { ?>border-left: <?php echo $settings->input_border['left']; ?>px <?php echo $settings->border_style; ?> #<?php echo $settings->border_color; ?>; <?php } ?>
		<?php if( $settings->input_border['right'] != '' ) { ?>border-right: <?php echo $settings->input_border['right']; ?>px <?php echo $settings->border_style; ?> #<?php echo $settings->border_color; ?>;  <?php } ?>
...
.fl-node-<?php echo $id; ?> .njba-contact-form.njba-form-style3 .njba-input-group-wrap textarea{
	...
	<?php if( $settings->textarea_border['top'] != '' ) { ?> border-top: <?php echo $settings->textarea_border['top']; ?>px <?php echo $settings->border_style; ?> #<?php echo $settings->border_color; ?>;  <?php } ?>
		<?php if( $settings->textarea_border['bottom'] != '' ) { ?>border-bottom: <?php echo $settings->textarea_border['bottom']; ?>px <?php echo $settings->border_style; ?> #<?php echo $settings->border_color; ?>; <?php } ?>
		<?php if( $settings->textarea_border['left'] != '' ) { ?>border-left: <?php echo $settings->textarea_border['left']; ?>px <?php echo $settings->border_style; ?> #<?php echo $settings->border_color; ?>; <?php } ?>
		<?php if( $settings->textarea_border['right'] != '' ) { ?>border-right: <?php echo $settings->textarea_border['right']; ?>px <?php echo $settings->border_style; ?> #<?php echo $settings->border_color; ?>;  <?php } ?>
		<?php if( $settings->border_radius != '' ) { ?>border-radius: <?php echo $settings->border_radius; ?>px;<?php } ?>
}
<?php 
...
.fl-node-<?php echo $id; ?> .njba-contact-form {
	 ...
	 <?php if( $settings->form_padding['top'] != '' ) { ?> padding-top: <?php echo $settings->form_padding['top']; ?>px;<?php } ?>
	<?php if( $settings->form_padding['bottom'] != '' ) { ?>padding-bottom: <?php echo $settings->form_padding['bottom']; ?>px; <?php } ?>
	<?php if( $settings->form_padding['left'] != '' ) { ?>padding-left: <?php echo $settings->form_padding['left']; ?>px; <?php } ?>
	<?php if( $settings->form_padding['right'] != '' ) { ?>padding-right: <?php echo $settings->form_padding['right']; ?>px; <?php } ?>
	background: #<?php echo $settings->form_bg_color; ?>;
	<?php if( $settings->form_border_width['top'] != '' ) { ?> border-top: <?php echo $settings->form_border_width['top']; ?>px <?php echo $settings->form_border_style; ?> #<?php echo $settings->form_border_color; ?>;  <?php } ?>
	<?php if( $settings->form_border_width['bottom'] != '' ) { ?>border-bottom: <?php echo $settings->form_border_width['bottom']; ?>px <?php echo $settings->form_border_style; ?> #<?php echo $settings->form_border_color; ?>; <?php } ?>
	<?php if( $settings->form_border_width['left'] != '' ) { ?>border-left: <?php echo $settings->form_border_width['left']; ?>px <?php echo $settings->form_border_style; ?> #<?php echo $settings->form_border_color; ?>; <?php } ?>
	<?php if( $settings->form_border_width['right'] != '' ) { ?>border-right: <?php echo $settings->form_border_width['right']; ?>px <?php echo $settings->form_border_style; ?> #<?php echo $settings->form_border_color; ?>;  <?php } ?>
	<?php if( $settings->form_radius != '' ) { ?>border-radius: <?php echo $settings->form_radius; ?>px;<?php } ?>
	-webkit-box-shadow: <?php if( isset($settings->form_box_shadow['horizontal'] ) ) { echo $settings->form_box_shadow['horizontal']; } ?>px  <?php if( isset($settings->form_box_shadow['vertical'] ) ) {  echo $settings->form_box_shadow['vertical']; } ?>px <?php if( isset($settings->form_box_shadow['blur'] ) ) { echo $settings->form_box_shadow['blur']; } ?>px <?php if( isset($settings->form_box_shadow['spread'] ) ) { echo $settings->form_box_shadow['spread']; } ?>px #<?php echo $settings->box_shadow_color; ?>; <?php echo $settings->box_shadow_opacity / 100; ?>;
	
     
    -moz-box-shadow: <?php if( isset($settings->form_box_shadow['horizontal'] ) ) { echo $settings->form_box_shadow['horizontal']; } ?>px <?php if( isset($settings->form_box_shadow['vertical'] ) ) {echo $settings->form_box_shadow['vertical']; } ?>px <?php if( isset($settings->form_box_shadow['blur'] ) ) { echo $settings->form_box_shadow['blur']; } ?>px <?php if( isset($settings->form_box_shadow['spread'] ) ) {echo $settings->form_box_shadow['spread']; } ?>px #<?php echo $settings->box_shadow_color; ?>; <?php echo $settings->box_shadow_opacity / 100; ?>;
    -o-box-shadow: <?php if( isset($settings->form_box_shadow['horizontal'] ) ) { echo $settings->form_box_shadow['horizontal']; } ?>px <?php if( isset($settings->form_box_shadow['vertical'] ) ) { echo $settings->form_box_shadow['vertical']; } ?>px <?php if( isset($settings->form_box_shadow['blur'] ) ) { echo $settings->form_box_shadow['blur']; } ?>px <?php if( isset($settings->form_box_shadow['spread'] ) ) { echo $settings->form_box_shadow['spread']; } ?>px #<?php echo $settings->box_shadow_color; ?>; <?php echo $settings->box_shadow_opacity / 100; ?>;
    box-shadow: <?php if( isset($settings->form_box_shadow['horizontal'] ) ) { echo $settings->form_box_shadow['horizontal']; } ?>px <?php if( isset($settings->form_box_shadow['vertical'] ) ) { echo $settings->form_box_shadow['vertical']; } ?>px <?php if( isset($settings->form_box_shadow['blur'] ) ) { echo $settings->form_box_shadow['blur']; } ?>px <?php if( isset($settings->form_box_shadow['spread'] ) ) { echo $settings->form_box_shadow['spread']; }?>px #<?php echo $settings->box_shadow_color; ?>; <?php echo $settings->box_shadow_opacity / 100; ?>;
...
<?php if( $settings->input_custom_width == 'custom' ) { ?>
	...
	.fl-node-<?php echo $id; ?> .njba-contact-form .njba-input-group.njba-message
	 {
		width: <?php echo $settings->input_textarea_width; ?>%;
	}
...
.fl-node-<?php echo $id; ?> .njba-contact-form .njba-inline-group:nth-child(2n) {
 <?php if( $settings->input_spacing ) { ?>  padding-left: <?php echo $settings->input_spacing; ?>px;  <?php } ?>	
}
.fl-node-<?php echo $id; ?> .njba-contact-form .njba-inline-group:nth-child(2n+1) {
  <?php if( $settings->input_spacing ) { ?> padding-right: <?php echo $settings->input_spacing; ?>px; <?php } ?>	
}
