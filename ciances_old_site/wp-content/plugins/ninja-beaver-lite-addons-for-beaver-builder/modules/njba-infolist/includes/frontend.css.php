...
?>
        .fl-node-<?php echo $id;?> .njba-info-list-connector, .fl-node-<?php echo $id;?> .njba-info-list-connector-top {
                <?php if ( $settings->connector_color != "" ) { ?>
                        color: #<?php echo $settings->connector_color;?>;
                <?php } ?>
                <?php if ( $settings->connector_style != "" ) { ?>
                        border-style: <?php echo $settings->connector_style;?>;
                <?php } ?>
        }
        <?php
...
<?php
        ...
        ?>
                .fl-node-<?php echo $id; ?> .njba-infolist-list-<?php echo $i;?> .njba-infolist-img i{
                        <?php if($box_content->icon_color){?> color: #<?php echo $box_content->icon_color; ?>;<?php } ?>
                        ...
                        <?php if( $box_content->icon_bg_color ) { ?>background: rgba(<?php echo implode(',', FLBuilderColor::hex_to_rgb($box_content->icon_bg_color )) ?>, <?php echo $box_content->icon_bg_color_opc/100; ?>); <?php } ?>
                        <?php if($box_content->icon_bg_color) {?>
                                font-size:<?php echo $settings->icon_image_size / 2; ?>px;
                        <?php } else { ?>
                                font-size:<?php echo $settings->icon_image_size; ?>px;
                        <?php } ?>
                        <?php if($settings->border_radius != '0'){?>
                ...
                .fl-node-<?php echo $id; ?> .njba-infolist-list-<?php echo $i; ?> .njba-infolist-content <?php echo $settings->title_tag_selection; ?>.heading {
                        ...
                        <?php if($settings->heading_padding['top'] ){ ?> padding-top: <?php echo $settings->heading_padding['top']; ?>px;<?php } ?>
                        <?php if($settings->heading_padding['right'] ){ ?> padding-right: <?php echo $settings->heading_padding['right']; ?>px;<?php } ?>
                        <?php if($settings->heading_padding['bottom'] ){ ?> padding-bottom: <?php echo $settings->heading_padding['bottom']; ?>px;<?php } ?>
                        <?php if($settings->heading_padding['left'] ){ ?> padding-left: <?php echo $settings->heading_padding['left']; ?>px;<?php } ?>
                        <?php if($settings->img_icon_position == 'center'){ ?>
                                margin-top: <?php echo $settings->heading_margin['top']; ?>px;
                ...
                .fl-node-<?php echo $id; ?> .njba-infolist-list-<?php echo $i; ?> .njba-infolist-content p {
                        ...
                        <?php if($settings->heading_subhead_padding['top'] ){ ?> padding-top: <?php echo $settings->heading_subhead_padding['top']; ?>px;<?php } ?>
                        <?php if($settings->heading_subhead_padding['right'] ){ ?> padding-right: <?php echo $settings->heading_subhead_padding['right']; ?>px;<?php } ?>
                        <?php if($settings->heading_subhead_padding['bottom'] ){ ?> padding-bottom: <?php echo $settings->heading_subhead_padding['bottom']; ?>px;<?php } ?>
                        <?php if($settings->heading_subhead_padding['left'] ){ ?> padding-left: <?php echo $settings->heading_subhead_padding['left']; ?>px;<?php } ?>
                }
