...
.fl-node-<?php echo $id; ?> .njba-subscribe-form {
	   <?php if( $settings->form_bg_type == 'color' && $settings->form_bg_color !='' ) { ?>background-color: rgba(<?php echo implode(',', FLBuilderColor::hex_to_rgb($settings->form_bg_color)) ?>, <?php echo $settings->form_background_opacity/100; ?>); <?php } ?>
	    ...
	    <?php if ( 'yes' == $settings->form_shadow_display ) { ?>
            ...
            -webkit-box-shadow: <?php if($settings->form_shadow['horizontal'] !=''){ echo $settings->form_shadow['horizontal']; ?>px <?php } if($settings->form_shadow['vertical'] !=''){ echo $settings->form_shadow['vertical']; ?>px <?php } if($settings->form_shadow['blur'] !=''){ echo $settings->form_shadow['blur']; ?>px <?php } if($settings->form_shadow['spread'] !=''){ echo $settings->form_shadow['spread']; ?>px <?php } ?> #<?php echo $settings->form_shadow_color;  ?>;
            -moz-box-shadow: <?php if($settings->form_shadow['horizontal'] !=''){ echo $settings->form_shadow['horizontal']; ?>px <?php } if($settings->form_shadow['vertical'] !=''){ echo $settings->form_shadow['vertical']; ?>px <?php } if($settings->form_shadow['blur'] !=''){ echo $settings->form_shadow['blur']; ?>px <?php } if($settings->form_shadow['spread'] !=''){ echo $settings->form_shadow['spread']; ?>px <?php } ?> #<?php echo $settings->form_shadow_color;  ?>;
            -o-box-shadow: <?php if($settings->form_shadow['horizontal'] !=''){ echo $settings->form_shadow['horizontal']; ?>px <?php } if($settings->form_shadow['vertical'] !=''){ echo $settings->form_shadow['vertical']; ?>px <?php } if($settings->form_shadow['blur'] !=''){ echo $settings->form_shadow['blur']; ?>px <?php } if($settings->form_shadow['spread'] !=''){ echo $settings->form_shadow['spread']; ?>px <?php } ?> #<?php echo $settings->form_shadow_color;  ?>;
            box-shadow: <?php if($settings->form_shadow['horizontal'] !=''){ echo $settings->form_shadow['horizontal']; ?>px <?php } if($settings->form_shadow['vertical'] !=''){ echo $settings->form_shadow['vertical']; ?>px <?php } if($settings->form_shadow['blur'] !=''){ echo $settings->form_shadow['blur']; ?>px <?php } if($settings->form_shadow['spread'] !=''){ echo $settings->form_shadow['spread']; ?>px <?php } ?> #<?php echo $settings->form_shadow_color;  ?>;
        <?php } ?>
...
.fl-node-<?php echo $id; ?> .njba-subscribe-form input[type=email] {
    ...
    <?php } ?>
    <?php if( isset($settings->input_font_size['desktop']) && $settings->input_size == 'custom' ) { ?>
...
.fl-node-<?php echo $id; ?> .njba-subscribe-form input[type=text]::-webkit-input-placeholder {
	...
	opacity: 0;
    <?php } ?>
	<?php if( isset($settings->placeholder_font_size['desktop']) && $settings->placeholder_size == 'custom' ) { ?>
...
.fl-node-<?php echo $id; ?> .njba-subscribe-form .njba-form-error-message {
    ...
    <?php } ?>
	<?php if( isset($settings->validation_error_font_size['desktop'] ) && $settings->success_message_size == 'custom' ) { ?>
...
.fl-node-<?php echo $id; ?> .njba-subscribe-form .njba-form-success-message {
	<?php if( isset($settings->success_message_font_size['desktop']) && $settings->success_message_size == 'custom' ) { ?>
...
@media only screen and (max-width: 768px) {
	.fl-node-<?php echo $id; ?> .njba-subscribe-form input[type=text],
	.fl-node-<?php echo $id; ?> .njba-subscribe-form input[type=email] {
		<?php if( isset($settings->input_font_size['tablet'])  && $settings->input_size == 'custom' ) { ?>
	    font-size: <?php echo $settings->input_font_size['tablet']; ?>px;
	    <?php } ?>
	}
	.fl-node-<?php echo $id; ?> .njba-subscribe-form .njba-sub-form-error-message {
		<?php if( isset($settings->validation_error_font_size['tablet']) && $settings->success_message_size == 'custom' ) { ?>
	    font-size: <?php echo $settings->validation_error_font_size['tablet']; ?>px;
	    <?php } ?>
	}
	.fl-node-<?php echo $id; ?> .njba-subscribe-form .njba-form-success-message {
		<?php if( isset($settings->success_message_font_size['tablet']) && $settings->success_message_size == 'custom' ) { ?>
	    font-size: <?php echo $settings->success_message_font_size['tablet']; ?>px;
	    <?php } ?>
	}
	.fl-node-<?php echo $id; ?> .njba-subscribe-form input[type=text]::-webkit-input-placeholder,
	.fl-node-<?php echo $id; ?> .njba-subscribe-form input[type=email]::-webkit-input-placeholder {
		<?php if( isset($settings->placeholder_font_size['tablet']) && $settings->placeholder_size == 'custom' ) { ?>
...
@media only screen and (max-width: 480px) {
	.fl-node-<?php echo $id; ?> .njba-subscribe-form input[type=text],
	.fl-node-<?php echo $id; ?> .njba-subscribe-form input[type=email] {
		<?php if( isset($settings->input_font_size['mobile'] ) && $settings->input_size == 'custom' ) { ?>
	    font-size: <?php echo $settings->input_font_size['mobile']; ?>px;
	    <?php } ?>
	}
	
	.fl-node-<?php echo $id; ?> .njba-subscribe-form .njba-sub-form-error-message {
		<?php if( isset($settings->validation_error_font_size['mobile']) && $settings->success_message_size == 'custom' ) { ?>
	    font-size: <?php echo $settings->validation_error_font_size['mobile']; ?>px;
	    <?php } ?>
	}
	.fl-node-<?php echo $id; ?> .njba-subscribe-form .njba-form-success-message {
		<?php if( isset($settings->success_message_font_size['mobile']) && $settings->success_message_size == 'custom' ) { ?>
