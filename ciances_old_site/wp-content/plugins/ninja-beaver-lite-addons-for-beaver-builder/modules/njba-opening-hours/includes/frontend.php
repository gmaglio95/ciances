	...
	?>
					...
					<li>
						...
						<div class="njba-opening-hours">
							...
							<?php if($panel->time_2 !='') { if($panel->time_separator !='none') {?><span class="njba-opening-hours-separator"><?php echo $panel->time_separator; ?></span><?php } ?> <span><?php echo $panel->time_2; ?></span><?php }	?>
						</div>
					</li>
