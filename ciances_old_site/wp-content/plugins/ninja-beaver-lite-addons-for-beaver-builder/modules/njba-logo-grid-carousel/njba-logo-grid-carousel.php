 ...
 */
FLBuilder::register_module('NJBALogoGrideModule', array(
	'general'      => array( // Tab
			...
			'heading'       => array( // Section
				...
				'fields'        => array( // Section Fields
                    ...
                    'img_max_width'    => array(
                        ...
                        'preview'       => array(
                            'type'          => 'css',
                            'selector'      => '.njba-image-responsive',
                        )
                    ),
            ...
            'arrow_nav'       => array( // Section
                ...
                'fields'        => array( // Section Fields
                    ...
                    'arrow_border_radius'    => array(
                        ...
                        'maxlength'     => '3',
                        'size'          => '5',
                        'label'         => __('Arrow Corners', 'bb-njba'),
                ...
                'fields'        => array( // Section Fields
                   ...
                   'col_hover_bg_color'    => array(
                    ...
                    'col_hover_border_style'     => array(
                        'type'      => 'select',
                        'label'     => __('Border Style On Hover', 'bb-njba'),
                        'default'     => 'none',
                        'options'       => array(
                             'none'          => __('None', 'bb-njba'),
                             'solid'          => __('Solid', 'bb-njba'),
                    ...
                    'col_out_padding'      => array(
                        ...
                        'label'             => __('Outside Padding', 'bb-njba'),
                        'default'           => array(
                            'top'               => '',
                            'bottom'            => '',
                            'left'              => '',
                    ...
                    'col_inner_padding'      => array(
                        'type'              => 'njba-multinumber',
                        'label'             => __('Inside Padding', 'bb-njba'),
                        'default'           => array(
                            'top'               => '',
                            'bottom'            => '',
                            'left'              => '',
