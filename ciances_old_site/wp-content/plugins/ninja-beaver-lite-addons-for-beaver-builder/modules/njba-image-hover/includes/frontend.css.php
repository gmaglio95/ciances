<?php if( $settings->style == '1' ) { ?>
    ...
    .fl-node-<?php echo $id; ?> .njba-image-hover-box-main .njba-image-box-content h1{
      ...
      <?php if( !empty($settings->font_size['desktop'] )) { ?>font-size: <?php echo $settings->font_size['desktop']; ?>px;<?php } ?>
      <?php if( $settings->font_color ) { ?>color: #<?php echo $settings->font_color; ?>;<?php } ?>
      padding: <?php echo $settings->caption_padding; ?>px;
    }
    .fl-node-<?php echo $id; ?> .njba-image-hover-box-main .njba-square-hover .njba-box-border-line {
    
    <?php if( $settings->inside_primary_border_color ) { ?>border-color: #<?php echo $settings->inside_primary_border_color; ?>;<?php } ?>
    ...
    .fl-node-<?php echo $id; ?> .njba-image-box.njba-square-hover .njba-image-box-content h1 span{
         <?php if( !empty($settings->first_font_size['desktop'] )) { ?>font-size: <?php echo $settings->first_font_size['desktop']; ?>px;<?php } ?>
         <?php if( $settings->first_font_color ) { ?>color: #<?php echo $settings->first_font_color; ?>;<?php } ?>
    }
    .fl-node-<?php echo $id; ?> .njba-box-line.njba-box-line-top, .fl-node-<?php echo $id; ?> .njba-box-line.njba-box-line-right, .fl-node-<?php echo $id; ?> .njba-box-line.njba-box-line-bottom, .fl-node-<?php echo $id; ?> .njba-box-line.njba-box-line-left{
        <?php if( $settings->inside_secondary_border_color ) { ?>background-color: #<?php echo $settings->inside_secondary_border_color; ?>;<?php } ?>
}
...
.fl-node-<?php echo $id; ?> .njba-square-hover .njba-image-box-overlay{
        <?php if( $settings->hover_color ) { ?>background-color: rgba(<?php echo implode(',', FLBuilderColor::hex_to_rgb($settings->hover_color)) ?>, <?php echo $settings->hover_opacity/100; ?>); <?php } ?>
       
}
@media only screen and (max-width: 768px) {
    .fl-node-<?php echo $id; ?> .njba-image-hover-box-main .njba-image-box-content h1{
        
        <?php if( !empty($settings->font_size['medium'] )) { ?>font-size: <?php echo $settings->font_size['medium']; ?>px;<?php } ?>
    }
    .fl-node-<?php echo $id; ?> .njba-image-box.njba-square-hover .njba-image-box-content h1 span{
         <?php if( !empty($settings->first_font_size['medium'] )) { ?>font-size: <?php echo $settings->first_font_size['medium']; ?>px;<?php } ?>
...
@media only screen and (max-width: 480px) {
    .fl-node-<?php echo $id; ?> .njba-image-hover-box-main .njba-image-box-content h1{
        ...
        <?php if( !empty($settings->font_size['small'] )) { ?>font-size: <?php echo $settings->font_size['small']; ?>px;<?php } ?>
    }
    .fl-node-<?php echo $id; ?> .njba-image-box.njba-square-hover .njba-image-box-content h1 span{
         <?php if( !empty($settings->first_font_size['small'] )) { ?>font-size: <?php echo $settings->first_font_size['small']; ?>px;<?php } ?>
...
.fl-node-<?php echo $id; ?> .njba-image-box.njba-square-hover-three .njba-box-border-line-double{
        ...
        <?php if( $settings->inside_primary_border_color ) { ?>border-color: #<?php echo $settings->inside_primary_border_color; ?>;<?php } ?>
        <?php if( $settings->inside_primary_border ) { ?>border-style: <?php echo $settings->inside_primary_border; ?>;<?php } ?>
}
.fl-node-<?php echo $id; ?> .njba-image-box.njba-square-hover-three .njba-box-border-line{
    
        <?php if( $settings->inside_secondary_border_color ) { ?>border-color: #<?php echo $settings->inside_secondary_border_color; ?>;<?php } ?>
        <?php if( $settings->inside_secondary_border ) { ?>border-style: <?php echo $settings->inside_secondary_border; ?>;<?php } ?>
}
