...
'
    ...
    function license_notice()
    {
        ...
        if ( $license_status == 'expired' ) {
            ...
            echo sprintf( __('Your <strong>'.$wpz_theme_name.' theme</strong> license is <strong>%s</strong>, please %srenew your license key%s to enable theme updates', 'wpzoom'), $license_status, '<strong><a href="' . $this->get_renewal_link() . '">', '</a></strong>' );
            echo '</div>';
        } elseif ( $license_status == 'invalid' ) {
            echo '<div id="update-nag">';
            echo sprintf( __('If you want to receive updates for <strong>'.$wpz_theme_name.' theme</strong>, please %senter your license key%s or %spurchase a new license%s if you don\'t have one yet.', 'wpzoom'), '<strong><a href="admin.php?page=wpzoom-license">', '</a></strong>', '<strong><a href="https://www.wpzoom.com/themes/' . WPZOOM::$theme_raw_name . '/" target="_blank">', '</a></strong>' );
            echo '</div>';
        } elseif ( $license_status == 'inactive'  || $license_status == 'site_inactive' ) {
            echo '<div id="update-nag">';
            echo sprintf( __('Your <strong>'.$wpz_theme_name.' theme</strong> license key is <strong>inactive</strong>. Please %sgo to this page%s and click the <strong>Activate License</strong> button to enable theme updates', 'wpzoom'), '<strong><a href="admin.php?page=wpzoom-license">', '</a></strong>' );
            echo '</div>';
        } elseif ( $license_status == 'item_name_mismatch' ) {
            echo '<div id="update-nag">';
            echo sprintf( __('You have entered an incorrect license key for <strong>'.$wpz_theme_name.' theme</strong>. Please %senter a correct key%s or %spurchase a new license%s for theme you\'re currently using.', 'wpzoom'), '<strong><a href="admin.php?page=wpzoom-license">', '</a></strong>', '<strong><a href="https://www.wpzoom.com/themes/' . WPZOOM::$theme_raw_name . '/" target="_blank">', '</a></strong>' );
            echo '</div>';
        } elseif ( $license_status == 'disabled' ) {
            echo '<div id="update-nag">';
            echo sprintf( __('Your <strong>'.$wpz_theme_name.' theme</strong> license key is <strong>%s</strong>, please %scheck the status%s of your license or get in touch with the WPZOOM team for more details.', 'wpzoom'), $license_status, '<strong><a href="' . $this->get_renewal_link() . '">', '</a></strong>' );
            echo '</div>';
        } elseif ( $license_status != 'valid' ) {
            echo '<div id="update-nag">';
            echo sprintf( __('Your <strong>'.$wpz_theme_name.' theme</strong> license is <strong>%s</strong>, please %sactivate your license key%s to enable theme updates', 'wpzoom'), $license_status, '<strong><a href="' . $this->get_renewal_link() . '">', '</a></strong>' );
            echo '</div>';
        }
    }
    ...
    {
        wp_enqueue_style('vendd-admin-style', WPZOOM::get_root_uri() . '/components/theme-updater/admin.css');
    }
        ...
        <div class="cols-wrap">
            ...
            <div class="wpz_right-col">
                  ...
                  <div class="license-wrap">
                    ...
                    <p>
                        <?php echo sprintf( __( 'Enter your license key to enable <strong>automatic theme updates</strong>. You can find your license in <a href="https://www.wpzoom.com/account/licenses/" target="_blank">WPZOOM Members Area &rarr; Licenses</a>.', 'wpzoom' ) );
                         ?>
                    </p>
                ...
                <div class="video_channel">
                    ...
                    <div class="video_channel_promo">
                        ...
                        <a href="https://www.wpzoom.com/video/" target="_blank"><img
                                src="//www.wpzoom.com/wp-content/themes/wpzoom/images/video_thumb.png"
